...
public class Main extends JPanel implements ActionListener {
	...
	public void addPieceToBoard(Piece piece, int rank, int file) {
		
	}
	
	// function for debugging the chess board's mechanics
	// this is temporary
	private void debug(JPanel chessBoard) {
		chessBoard.getTreeLock();
